...
func (m *Manager) Connect(ctx context.Context, database *databasev1alpha1.Database) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *Manager) buildDSN(ctx context.Context, database *databasev1alpha1.Database) (string, *tls.Config, error) {

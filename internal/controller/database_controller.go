...
// +kubebuilder:rbac:groups=database.hauke.cloud,resources=databases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.hauke.cloud,resources=databases/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=database.hauke.cloud,resources=databases/finalizers,verbs=update
